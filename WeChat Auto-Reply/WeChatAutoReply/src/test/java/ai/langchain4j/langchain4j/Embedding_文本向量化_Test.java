package ai.langchain4j.langchain4j;
...
@SpringBootTest
public class Embedding_文本向量化_Test {
    @Autowired
...
//并使用默认的文档解析器对文档进行解析
        Document document1 = FileSystemDocumentLoader.loadDocument("E:\\WeChat Auto-Reply\\WeChatAutoReply\\src\\main\\resources\\zhaozhi-SysPrompt-Template.txt");
